...
class ConsumerCommand extends Command
{
    ...
    protected function processMessage(Message $kafkaMessage)
    {
        ...
        Stat::updateOrCreate(
            ['inventory_id' => isset($message->body) ? $message->body->id : 1],
            ['make' => isset($message->body) ? $message->body->make : null, 'model' => isset($message->body) ? $message->body->model : null]
        );
    }
